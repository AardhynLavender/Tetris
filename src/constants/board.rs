...
pub const BOARD_POSITION: Vec2<i32> = Vec2::new(SCREEN_CENTER.x - BOARD_DIMENSIONS.x as i32 * TILE_SIZE as i32 / 2, SCREEN_CENTER.y - BOARD_DIMENSIONS.y as i32 * TILE_SIZE as i32 / 2);
